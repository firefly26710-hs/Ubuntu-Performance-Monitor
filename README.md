...
### Data Source : 
#### Designed a polymorphic shared memory architecture using a fixed-size byte array across all metric modules, maximizing memory reuse and minimizing footprint and explicited 16-byte memory alignment for CPU thread slots to ensure peak cache efficiency
